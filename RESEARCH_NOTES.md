...
Reference open VLM lineage for reproducibility comparisons against published VLM claims we may cite.

## Planned adaptation notes

Baseline-only; not a production candidate. Use for research reproducibility and academic parity checks.
